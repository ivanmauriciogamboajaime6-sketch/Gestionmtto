...
def register_cliente(data: UsuarioCreate, db: Session = Depends(get_db)):
    ...
    correo_usuario_enviado = notification_service.notify_user_registered(nuevo_usuario)
    correo_admin_enviado = notification_service.notify_admin_user_registered(nuevo_usuario)
